...
var SHELL = ["./", "./index.html", "./style.css?v=23", "./app.js?v=23", "./notification-state.js", "./calendar-state.js", "./account-config.js", "./supabase-sync.js", "./account-auth.js", "./account-sync.js", "./manifest.webmanifest", "./data/calendar-events.json",
