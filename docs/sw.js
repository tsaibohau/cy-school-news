/* 嘉義校訊 Service Worker:離線快取殼層,資料採網路優先 */
/* ⚠ 殼層是快取優先:只要改了 app.js / style.css / index.html,就必須把
   下面的版本號 +1,否則已安裝 PWA 的使用者會一直用舊版檔案。 */
var CACHE = "cy-news-v99";
var SHELL = ["./", "./index.html", "./legal.html", "./legal-compliance.json", "./style.css?v=88", "./app.js?v=94", "./notification-state.js", "./calendar-state.js?v=44", "./account-config.js?v=44", "./supabase-sync.js?v=58", "./account-auth.js?v=79", "./capability-layer.js?v=10", "./push-subscription.js?v=41", "./reminder-rules.js?v=41", "./task-state.js?v=41", "./account-sync.js?v=56", "./school-registry.js?v=42", "./profile.js?v=41", "./relevance.js?v=41", "./assistant-feedback.js?v=41", "./today.js?v=41", "./search-taxonomy.js?v=52", "./search-query.js?v=52", "./announcement-validity-reviewed.js?v=52", "./announcement-validity.js?v=52", "./announcement-cleanup.js?v=82", "./assistant-qa.js?v=53", "./detail-ui.js?v=41", "./manifest.webmanifest", "./data/calendar-events.json", "./data/class-timetables.json",
...
self.addEventListener("push", function (e) {
  ...
  var title = typeof payload.title === "string" && payload.title.trim() ? payload.title.trim() : "嘉義校訊";
...
self.addEventListener("fetch", function (e) {
  ...
  /* Bootstrap and policy files are network-first so a successful deploy cannot be masked by an older shell cache. */
  if (/\/(account-config|capability-layer|supabase-sync)\.js$/.test(url.pathname) || /\/legal\.html$/.test(url.pathname)) {
    e.respondWith(
      fetch(req).then(function (res) {
        var copy = res.clone();
