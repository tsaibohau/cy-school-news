...
self.addEventListener("fetch", function (e) {
  ...
  /* Bootstrap files are network-first so a successful production deploy cannot be masked by an older shell cache. */
  if (/\/(account-config|capability-layer|supabase-sync)\.js$/.test(url.pathname)) {
    e.respondWith(
      fetch(req).then(function (res) {
        var copy = res.clone();
