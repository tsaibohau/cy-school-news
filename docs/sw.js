...
var CACHE = "cy-news-v36";
var SHELL = ["./", "./index.html", "./style.css?v=35", "./app.js?v=35", "./notification-state.js", "./calendar-state.js?v=35", "./account-config.js?v=35", "./supabase-sync.js?v=35", "./account-auth.js?v=35", "./push-subscription.js?v=35", "./reminder-rules.js?v=35", "./task-state.js?v=35", "./account-sync.js?v=35", "./school-registry.js?v=35", "./profile.js?v=35", "./relevance.js?v=35", "./today.js?v=35", "./detail-ui.js?v=35", "./manifest.webmanifest", "./data/calendar-events.json",
