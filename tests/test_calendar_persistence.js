...
write(CalendarState.upsert([], { id: stableId, title: "Original", date: "2026-08-22", notes: "note", importance: "reference" }));
assert.deepEqual(read(), [{ id: stableId, title: "Original", date: "2026-08-22", notes: "note", importance: "reference" }]);

write(CalendarState.upsert(read(), { id: stableId, title: "Edited", date: "2026-08-24", notes: "updated", importance: "important" }));
assert.deepEqual(read(), [{ id: stableId, title: "Edited", date: "2026-08-24", notes: "updated", importance: "important" }]);
