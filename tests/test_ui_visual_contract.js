...
assert.match(index, /search-taxonomy\.js\?v=45/, "search taxonomy loads before the query parser");
assert.match(index, /search-query\.js\?v=45/, "semantic search terms load before the application");
