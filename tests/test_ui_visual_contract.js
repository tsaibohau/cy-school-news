...
assert.match(index, /search-taxonomy\.js\?v=47/, "search taxonomy loads before the query parser");
assert.match(index, /search-query\.js\?v=47/, "semantic search terms load before the application");
