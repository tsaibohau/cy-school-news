...
assert.match(style, /--calligraphy:/, "calligraphy is scoped to brand display text");
...
assert.match(app, /無法確認時會明確標示/, "assistant still explains uncertainty without defensive wording");
