...
assert.match(index, /search-taxonomy\.js\?v=46/, "search taxonomy loads before the query parser");
assert.match(index, /search-query\.js\?v=46/, "semantic search terms load before the application");
