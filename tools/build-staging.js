...
const sourceVersions = ["?v=41", "?v=42", "?v=43", "?v=44", "?v=45", "?v=46", "?v=47", "?v=48", "?v=49", "?v=50", "?v=51", "?v=52", "?v=53", "?v=54"];
...
let sw = fs.readFileSync(swPath, "utf8")
  .replace('var CACHE = "cy-news-v54";', 'var CACHE = "cy-news-' + shellRevision + '";')
