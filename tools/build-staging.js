...
const shellInputs = [
  ...
  "reminder-rules.js",
  "school-registry.js", "profile.js", "relevance.js", "assistant-feedback.js", "today.js", "search-taxonomy.js", "search-query.js", "announcement-validity.js", "assistant-qa.js", "calendar-state.js",
...
const sourceVersions = ["?v=41", "?v=42", "?v=43", "?v=44", "?v=45", "?v=46", "?v=47", "?v=48", "?v=49"];
...
let sw = fs.readFileSync(swPath, "utf8")
  .replace('var CACHE = "cy-news-v49";', 'var CACHE = "cy-news-' + shellRevision + '";')
