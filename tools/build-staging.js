...
const shellInputs = [
  ...
  "reminder-rules.js",
  "school-registry.js", "profile.js", "relevance.js", "assistant-feedback.js", "today.js", "assistant-qa.js", "calendar-state.js",
...
let sw = fs.readFileSync(swPath, "utf8")
  .replace('var CACHE = "cy-news-v39";', 'var CACHE = "cy-news-' + shellRevision + '";')
  .replaceAll(sourceVersion, stagedVersion)
